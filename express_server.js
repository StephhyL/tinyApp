...
app.post("/urls", (req, res) => {
  ...
  if (userID) {
    ...
    // Sends error if user is not logged in
...
app.post("/urls/:id", (req, res)=>{
  ...
  // Checks if the user trying to change the URL is the owner of the URL
...
app.post("/urls/:shortURL/delete", (req, res) => {
  ...
  // Checking if the user trying to change the URL is the owner of the URL. If so, delete, and redirect to /urls
